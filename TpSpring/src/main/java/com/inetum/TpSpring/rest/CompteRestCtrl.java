...
import com.inetum.TpSpring.util.DtoConverter;
...
public class CompteRestCtrl {
	...
	public List<CompteDto> getAllCustomer() {
		return dtoConverter.compteToCompteDto(serviceCompte.trouverTousLesComptes());
	}
	...
	public Compte getCompteById(@PathVariable("numeroCompte") Long code) {
		return serviceCompte.findCompteWithid(code);
	}
	
	@PostMapping("")
	public Compte postCompte(@RequestBody Compte compte) {
		return serviceCompte.sauvegarderCompte(compte);
	}
