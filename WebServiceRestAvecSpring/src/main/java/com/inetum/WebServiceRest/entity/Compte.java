...
@Entity
// Plus utile car ces fonctions peuvent être générées automatiquement par Spring
@NamedQuery(name="Compte.allCompteWithMin", query="SELECT c FROM Compte c WHERE c.solde>?1")
